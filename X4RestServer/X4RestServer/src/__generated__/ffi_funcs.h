...
namespace X4FFI
{
    ...
    using GetAutosaveIntervalOption = AutosaveIntervalInfo (*)(void);
    ...
    using GetWidgetSystemSizeOverride = Coord2D (*)(void);
    ...
    using GetCurrentCursorInfo = CursorInfo (*)(void);
    ...
    using GetMissionInfo2 = MissionInfo2 (*)(void);
    ...
    using GetGameResolution = ResolutionInfo (*)(void);
    using GetRenderResolutionOption = ResolutionInfo (*)(void);
    ...
    using GetLastSaveInfo = UISaveInfo (*)(void);
    ...
    using AreGfxSettingsTooHigh = bool (*)(void);
    ...
    using GetChromaticAberrationOption = bool (*)(void);
    ...
    using GetForceShootingAtCursorOption = bool (*)(void);
    ...
    using GetHUDSeparateRadar = bool (*)(void);
    ...
    using GetMouseOverTextOption = bool (*)(void);
    ...
    using GetSavesCompressedOption = bool (*)(void);
    using GetScreenDisplayOption = bool (*)(void);
    ...
    using GetSpeakTargetNameOption = bool (*)(void);
    ...
    using GetVentureOption = bool (*)(void);
    using GetVisitorNamesShownOption = bool (*)(void);
    ...
    using HasSavegame = bool (*)(void);
    using HasSeta = bool (*)();
    using HasShipFlightAssist = bool (*)(UniverseID shipid);
    using HasStartAnimation = bool (*)(void);
    ...
    using IsAppStoreVersion = bool (*)(void);
    ...
    using IsCurrentGPUDiscrete = bool (*)(void);
    ...
    using IsLanguageSettingEnabled = bool (*)(void);
    using IsLanguageValid = bool (*)(void);
    ...
    using IsMiniWidgetSystemUsed = bool (*)(void);
    ...
    using IsMouseSteeringAdapative = bool (*)(void);
    using IsNavBeacon = bool (*)(const UniverseID componentid);
    using IsNetworkEngineEnabled = bool (*)(void);
    ...
    using IsSaveListLoadingComplete = bool (*)(void);
    ...
    using IsThrottleBidirectional = bool (*)(void);
    using IsTitleFontString = bool (*)(const int fontstringid);
    using IsTobiiAvailable = bool (*)(void);
    using IsTradeShowVersion = bool (*)(void);
    ...
    using IsVROculusTouchActive = bool (*)(void);
    using IsVRPointerActive = bool (*)();
    using IsVRVersion = bool (*)(void);
    using IsVRViveControllerActive = bool (*)(void);
    ...
    using QueryGameServers = bool (*)(void);
    ...
    using GetBuildVersionSuffix = const char* (*)(void);
    ...
    using GetCurrentGPUNiceName = const char* (*)(void);
    using GetCurrentSoundDevice = const char* (*)(void);
    ...
    using GetPresentModeOption = const char* (*)(void);
    using GetPurposeName = const char* (*)(const char* purposeid);
    using GetRealComponentClass = const char* (*)(UniverseID componentid);
    using GetSSROption2 = const char* (*)(void);
    using GetSaveLocationName = const char* (*)(void);
    ...
    using GetSteamID = const char* (*)(void);
    ...
    using GetTextureQualityOption = const char* (*)(void);
    using GetTobiiMode = const char* (*)(void);
    using GetTrackerNameOption = const char* (*)(void);
    using GetTrackerSDKOption = const char* (*)(void);
    ...
    using GetAdaptiveSamplingOption = float (*)(void);
    using GetCockpitCameraScaleOption = float (*)(void);
    ...
    using GetTobiiAngleFactor = float (*)(void);
    using GetTobiiDeadzoneAngle = float (*)(void);
    using GetTobiiDeadzonePosition = float (*)(void);
    using GetTobiiGazeAngleFactor = float (*)(void);
    using GetTobiiGazeDeadzone = float (*)(void);
    using GetTobiiHeadPositionFactor = float (*)(void);
    ...
    using GetVRVivePointerHand = int (*)(void);
    ...
    using GetCurrentLanguage = int32_t (*)(void);
    ...
    using GetRequestedLanguage = int32_t (*)(void);
    ...
    using GetTobiiGazeFilterStrength = size_t (*)(void);
    using GetTobiiHeadFilterStrength = size_t (*)(void);
    ...
    using GetLUTMode = uint32_t (*)(void);
    ...
    using GetMouseHUDModeOption = uint32_t (*)(void);
    ...
    using GetNumLanguages = uint32_t (*)(void);
    ...
    using GetNumSoundDevices = uint32_t (*)(void);
    ...
    using GetNumTimeline = uint32_t (*)(void);
    ...
    using DeactivateDirectInput = void (*)(void);
    using DeactivateMouseEmulation = void (*)(void);
    ...
    using DisableEncryptedDirectInputMode = void (*)(void);
    ...
    using EnableEncryptedDirectInputMode = void (*)(void);
    ...
    using ReloadSaveList = void (*)(void);
    ...
    using StartStartMenuBGMusic = void (*)(void);
    ...
    using StopStartMenuBGMusic = void (*)(void);
    using StopVoiceSequence = void (*)(void);
    using StoreConstructionMapState = void (*)(UniverseID holomapid);
    using TargetRadarComponent = void (*)(void);
    using ToggleDrones = void (*)(uint32_t dronetype);
    using ToggleFlightAssist = void (*)();
    using ToggleScreenDisplayOption = void (*)(void);
